...
namespace App
{
    ...
    public sealed class GameContext
    {
        ...
        /// <summary>現在ステージの設定。null の場合は Config の値をフォールバックとして使う</summary>
        public  StageConfig?     CurrentStage { get; set; }
        ...
        /// <summary>ゲームをリスタートする。GameClearView の RETRY ボタンから呼ぶ</summary>
